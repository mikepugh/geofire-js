...
function validateCriteria(newQueryCriteria, requireCenterAndRadius) {
    ...
    if (typeof newQueryCriteria !== 'object') {
        ...
        (typeof newQueryCriteria.center === 'undefined' || typeof newQueryCriteria.radius === 'undefined')) {
...
var GeoQuery = /** @class */ (function () {
   ...
   */
    GeoQuery.prototype._childAddedCallback = function (locationDataSnapshot) {
        this._updateLocation(geoFireGetKey(locationDataSnapshot), decodeGeoFireObject(locationDataSnapshot.val()), decodeGeoFireDataObject(locationDataSnapshot.val()));
    };
    /**
   ...
   */
    GeoQuery.prototype._fireCallbacksForKey = function (eventType, key, location, distanceFromCenter, data) {
   ...
   */
    GeoQuery.prototype._listenForNewGeohashes = function () {
        ...
        geohashesToQuery.forEach(function (toQueryStr) {
            ...
            var firebaseQuery = _this._firebaseRef
                .orderByChild('g')
                .startAt(query[0])
                .endAt(query[1]);
   ...
   * @param location The location as [latitude, longitude] pair.
   */
    GeoQuery.prototype._updateLocation = function (key, location, data) {
        validateLocation(location);
...
var GeoFire = /** @class */ (function () {
   ...
   */
    ...
    GeoFire.prototype.getWithData = function (key) {
        validateKey(key);
        return this._firebaseRef.child(key).once('value').then(function (dataSnapshot) {
            var snapshotVal = dataSnapshot.val();
            if (snapshotVal === null) {
   ...
   */
    GeoFire.prototype.set = function (keyOrLocations, location, data) {
        var locations;
