 ...
 */
export declare function encodeGeoFireObject(location: number[], geohash: string, data?: any): GeoFireObj;
/**
 ...
 */
export declare function decodeGeoFireDataObject(geoFireObj: GeoFireObj): any;
/**
